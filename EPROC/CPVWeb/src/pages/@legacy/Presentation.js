...
import pages from "../../@legacyDummyData/pages";
import features from "../../@legacyDummyData/features";
import getLanguageFromLocalStorage from "components/getLanguageFromLocalStorage/ChangeImageLogo";
      ...
      <Navbar variant="dark" expand="lg" bg="dark" className="navbar-transparent navbar-theme-primary sticky-top">
        <Container className="position-relative justify-content-between px-3">
          <Navbar.Brand as={HashLink} to="#home" className="me-lg-3 d-flex align-items-center">
            <Image src={Logo} />
            <span className="ms-2 brand-text d-none d-md-inline">CER KIMDIS</span>
          </Navbar.Brand>
