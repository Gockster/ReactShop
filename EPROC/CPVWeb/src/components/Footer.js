        ...
        <Row>
          <Col xs={12} lg={6} className="mb-4 mb-lg-0">
            <p className="mb-0 text-center text-xl-left">
              ...
              <Card.Link href="https://cerpp.eprocurement.gov.gr/upgkimdis/unprotected/home.xhtml" target="_blank" className="text-blue text-decoration-none fw-normal">
                {i18next.t("generic.kimdis")}
            </Card.Link>
            </p>
          </Col>
          <Col xs={12} lg={6}>
            <ul className="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://www.ose.gr" target="_blank">
                  About
              </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
